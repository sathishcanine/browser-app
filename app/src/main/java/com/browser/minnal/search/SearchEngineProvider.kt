package com.browser.minnal.search

import com.browser.minnal.browser.di.SuggestionsClient
import com.browser.minnal.log.Logger
import com.browser.minnal.preference.UserPreferences
import com.browser.minnal.search.engine.AskSearch
import com.browser.minnal.search.engine.BaiduSearch
import com.browser.minnal.search.engine.BaseSearchEngine
import com.browser.minnal.search.engine.BingSearch
import com.browser.minnal.search.engine.CustomSearch
import com.browser.minnal.search.engine.DuckLiteSearch
import com.browser.minnal.search.engine.DuckSearch
import com.browser.minnal.search.engine.GoogleSearch
import com.browser.minnal.search.engine.NaverSearch
import com.browser.minnal.search.engine.StartPageMobileSearch
import com.browser.minnal.search.engine.StartPageSearch
import com.browser.minnal.search.engine.YahooSearch
import com.browser.minnal.search.engine.YandexSearch
import com.browser.minnal.search.suggestions.BaiduSuggestionsModel
import com.browser.minnal.search.suggestions.DuckSuggestionsModel
import com.browser.minnal.search.suggestions.GoogleSuggestionsModel
import com.browser.minnal.search.suggestions.NaverSuggestionsModel
import com.browser.minnal.search.suggestions.NoOpSuggestionsRepository
import com.browser.minnal.search.suggestions.RequestFactory
import com.browser.minnal.search.suggestions.SuggestionsRepository
