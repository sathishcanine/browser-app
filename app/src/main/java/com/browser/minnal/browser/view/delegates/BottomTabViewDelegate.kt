...
class BottomTabViewDelegate(binding: BrowserActivityBottomBinding) : ViewDelegate {
    ...
    override val drawerTabsList: RecyclerView = binding.tabGrid.drawerTabsList
    ...
    override val actionBack: ImageView = binding.tabGrid.actionBack
    override val actionForward: ImageView = binding.tabGrid.actionForward
    override val actionHome: ImageView = binding.tabGrid.actionHome
    override val newTabButton: ImageView = binding.tabGrid.newTabButton
    ...
    override val tabHeaderButton: ImageView = binding.tabGrid.tabHeaderButton
    ...
    override val urlActionsBar = binding.urlActionsBar
}
